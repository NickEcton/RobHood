...
class AssetForm extends React.Component {
  constructor(props) {
    super(props)
    this.state = { asset: "", data: [10], quantity: 0}
  ...
  handleOrderSubmit(e) {
    e.preventDefault();
    debugger
    this.props.createOrder({"asset_symbol": this.props.asset.stock.symbol, "portfolio_id": this.props.portfolio.id, "price": this.props.asset.closing, "quantity": this.state.quantity})
  }
                          ...
                          <div>
                            <div className="order-asset-detail">
                              <div className="order-shares-detail">
                                <label>
                                  <div>Shares</div>
                                  <div><input min="0" placeholder="0" value={this.state.quantity} onChange={this.orderUpdate()}/></div>
                                </label>
                              </div>
